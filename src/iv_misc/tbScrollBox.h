...
/*
 * Top to Bottom ScrollBox - scrollable list of glyphs with natural nums
 */

#ifndef tbscrollbox_h
#define tbscrollbox_h 1
...
class tbScrollBox : public ivScrollBox {
public:
  ivGlyphIndex	naturalnum;
  ivCoord	default_height;
  tbScrollBox(ivGlyphIndex size = 10);
  virtual ~tbScrollBox();
