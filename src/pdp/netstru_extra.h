...
public:
  ...
  virtual void	MakeFromNetView(NetView* view);
...
// need this to get template virtual table instantiated on _vt systems
typedef taPtrList<Unit> taPtrList_Unit;	// #IGNORE
