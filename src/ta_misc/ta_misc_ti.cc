...
// ta_misc_ti.cc: template instantiation file for ta_misc library
...
template class taPtrList<ScriptBase>;
...
template class taList<ViewLabel>;

template class DataArray<float_RArray>;
template class DataArray<String_Array>;
