...
inline istream& istream::operator>>(istream& (*_f) (istream&)){
    STREAM_RMUTEX_LOCK(this, lckp);
    (*_f)(*this);
    istream* oper_istream_return = this;
...
inline ostream& ostream::operator<<(ostream&(*_f)(ostream&)) {
  STREAM_RMUTEX_LOCK(this, lckp);
 (*_f)(*this);
  ostream* oper_ostream_return = this;
