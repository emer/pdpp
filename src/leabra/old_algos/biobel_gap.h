...
public:
  ...
  float		wt_off;		// sigmoidal function offset value
  ...
  { cn->wt_lin = WeightSigFunInv(cn->wt, wt_gain, wt_off); }
...
public:
  ...
  bool		rnd;		// whether to limit thresh changes to a random subset of units
  float		act_thr;
  // #HIDDEN activity threshold for adapting: don't change if unit is already helping
...
public:
  ...
  virtual bool	AdaptThreshTest(BioBelUnit* u, BioBelLayer* lay, BioBelInhib* thr, int phase);
  // compute long-term average activation, and test if thresh needs adapting
  virtual void	AdaptThresh(BioBelUnit* u, BioBelLayer* lay, BioBelInhib* thr, int phase);
...
public:
  ...
  bool		AdaptThreshTest(BioBelLayer* lay, BioBelInhib* thr, int phase)
  { return ((BioBelUnitSpec*)spec.spec)->AdaptThreshTest(this, lay, thr, phase); }
  void		AdaptThresh(BioBelLayer* lay, BioBelInhib* thr, int phase)
  { ((BioBelUnitSpec*)spec.spec)->AdaptThresh(this, lay, thr, phase); }
...
public:
  ...
  virtual void	AdaptThreshold(BioBelLayer* lay, int phase);
