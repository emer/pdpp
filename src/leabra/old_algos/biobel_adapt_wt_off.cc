...
void BioBelConSpec::InitLinks() {
  ConSpec::InitLinks();
  taBase::Own(wt_off, this);
  taBase::Own(wt_off_rng, this);
...
void BioBelConSpec::CreateWtSigFun() {
  ...
  for(i=0; i<wt_sig_fun.size; i++) {
    ...
    wt_sig_fun.FastEl(i) = WeightSigFun(w, wt_gain, wt_off.off);
  }
}
