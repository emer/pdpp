...
TypeDef TA_LeabraMaxDa("LeabraMaxDa", " _ stat that computes maximum change in activation, used for determining equilibrium to stop settling; also looks for maximum activation on target layers to provide that as an additional stopping criterion", 
...
TypeDef TA_KwtaTieBreak("KwtaTieBreak", " break ties where all the units have similar netinputs and thus none get activated. this lowers the inhibition so that all get active to some extent", 
	"", "INLINE NO_UPDATE_AFTER ", "", sizeof(KwtaTieBreak), (void**)&TAI_KwtaTieBreak, 0, 0, 0,1);
TypeDef TA_const_KWTASpec_ref("const_KWTASpec_ref", 1, 0, 1, 0,1);
TypeDef TA_const_KwtaTieBreak("const_KwtaTieBreak", 1, 0, 0, 0,1);
TypeDef TA_const_KwtaTieBreak_ref("const_KwtaTieBreak_ref", 1, 0, 1, 0,1);
...
TypeDef TA_LayNetRescaleSpec("LayNetRescaleSpec", " global rescale of layer netinputs to prevent blowup", 
	"", "INLINE NO_UPDATE_AFTER ", "", sizeof(LayNetRescaleSpec), (void**)&TAI_LayNetRescaleSpec, 0, 0, 0,1);
TypeDef TA_const_LayNetRescaleSpec("const_LayNetRescaleSpec", 1, 0, 0, 0,1);
TypeDef TA_KWTASpec_ref("KWTASpec_ref", 1, 0, 1, 0,1);
TypeDef TA_const_LayNetRescaleSpec_ref("const_LayNetRescaleSpec_ref", 1, 0, 1, 0,1);
...
TypeDef TA_const_LeabraPrjnRelNetinStat("const_LeabraPrjnRelNetinStat", 1, 0, 0, 0,1);
...
TypeDef TA_const_LeabraPrjnRelNetinStat_ref("const_LeabraPrjnRelNetinStat_ref", 1, 0, 1, 0,1);
...
TypeDef TA_TwoDValSpec("TwoDValSpec", " specs for two-dimensional values", 
	"", "INLINE NO_UPDATE_AFTER ", "", sizeof(TwoDValSpec), (void**)&TAI_TwoDValSpec, 0, 0, 0,1);
TypeDef TA_const_TwoDValSpec("const_TwoDValSpec", 1, 0, 0, 0,1);
TypeDef TA_const_TwoDValSpec_ref("const_TwoDValSpec_ref", 1, 0, 1, 0,1);
TypeDef TA_TwoDValBias("TwoDValBias", " initial bias for given activation value for scalar value units", 
	"", "INLINE NO_UPDATE_AFTER ", "", sizeof(TwoDValBias), (void**)&TAI_TwoDValBias, 0, 0, 0,1);
TypeDef TA_const_TwoDValBias("const_TwoDValBias", 1, 0, 0, 0,1);
TypeDef TA_const_TwoDValBias_ref("const_TwoDValBias_ref", 1, 0, 1, 0,1);
TypeDef TA_TwoDValLayerSpec("TwoDValLayerSpec", " represents one or more two-d value(s) using a coarse-coded distributed code over units. first row represents scalar value(s). one val readout is weighted-average; multiple vals = max bumps over 3x3 local grid", 
	"EXT_spec MEMB_IN_GPMENU ", "EXT_spec MEMB_IN_GPMENU ", "", sizeof(TwoDValLayerSpec), (void**)&TAI_TwoDValLayerSpec, 1, 0, 0,1);
TypeDef TA_const_TwoDValLayerSpec("const_TwoDValLayerSpec", 1, 0, 0, 0,1);
TypeDef TA_const_TwoDValLayerSpec_ref("const_TwoDValLayerSpec_ref", 1, 0, 1, 0,1);
...
TypeDef TA_PVDetectSpec("PVDetectSpec", " specs for detecting if a primary value is present or expected", 
	"", "INLINE NO_UPDATE_AFTER ", "", sizeof(PVDetectSpec), (void**)&TAI_PVDetectSpec, 0, 0, 0,1);
TypeDef TA_const_PVDetectSpec("const_PVDetectSpec", 1, 0, 0, 0,1);
TypeDef TA_const_PVDetectSpec_ref("const_PVDetectSpec_ref", 1, 0, 1, 0,1);
TypeDef TA_PViLayerSpec("PViLayerSpec", " primary value inhibitory (PVi) layer: continously learns to expect primary reward values", 
	"EXT_spec MEMB_IN_GPMENU ", "EXT_spec MEMB_IN_GPMENU ", "", sizeof(PViLayerSpec), (void**)&TAI_PViLayerSpec, 1, 0, 0,1);
TypeDef TA_const_PViLayerSpec("const_PViLayerSpec", 1, 0, 0, 0,1);
TypeDef TA_const_PViLayerSpec_ref("const_PViLayerSpec_ref", 1, 0, 1, 0,1);
...
TypeDef TA_LVeLayerSpec("LVeLayerSpec", " learns value based on inputs that are associated with rewards, only learns at time of primary rewards (filtered by PV system). This is excitatory version", 
	"EXT_spec MEMB_IN_GPMENU ", "EXT_spec MEMB_IN_GPMENU ", "", sizeof(LVeLayerSpec), (void**)&TAI_LVeLayerSpec, 1, 0, 0,1);
TypeDef TA_const_LVeLayerSpec("const_LVeLayerSpec", 1, 0, 0, 0,1);
TypeDef TA_const_LVeLayerSpec_ref("const_LVeLayerSpec_ref", 1, 0, 1, 0,1);
TypeDef TA_LViLayerSpec("LViLayerSpec", " inhibitory/slow version of LV layer spec: (just a marker for layer; same functionality as LVeLayerSpec)", 
	"EXT_spec MEMB_IN_GPMENU ", "EXT_spec MEMB_IN_GPMENU ", "", sizeof(LViLayerSpec), (void**)&TAI_LViLayerSpec, 1, 0, 0,1);
TypeDef TA_const_LViLayerSpec("const_LViLayerSpec", 1, 0, 0, 0,1);
TypeDef TA_const_LViLayerSpec_ref("const_LViLayerSpec_ref", 1, 0, 1, 0,1);
...
TypeDef TA_MatrixErrRndGoSpec("MatrixErrRndGoSpec", " matrix random Go firing to encourage exploration when (a series of) errors occur: a stripe is chosen from a softmax over the snrthal netinputs (closer to firing chosen with higher probability)", 
	"INLINE ", "INLINE NO_UPDATE_AFTER ", "", sizeof(MatrixErrRndGoSpec), (void**)&TAI_MatrixErrRndGoSpec, 0, 0, 0,1);
TypeDef TA_const_MatrixErrRndGoSpec("const_MatrixErrRndGoSpec", 1, 0, 0, 0,1);
TypeDef TA_const_MatrixErrRndGoSpec_ref("const_MatrixErrRndGoSpec_ref", 1, 0, 1, 0,1);
TypeDef TA_MatrixAvgDaRndGoSpec("MatrixAvgDaRndGoSpec", " matrix random Go firing to encourage exploration for non-productive stripes based on softmax of avg_go_da for that stripe (matrix_u->misc_1)", 
	"INLINE ", "INLINE NO_UPDATE_AFTER ", "", sizeof(MatrixAvgDaRndGoSpec), (void**)&TAI_MatrixAvgDaRndGoSpec, 0, 0, 0,1);
TypeDef TA_LeabraUnit_Group_ptr("LeabraUnit_Group_ptr", 1, 1, 0, 0,1);
TypeDef TA_const_MatrixAvgDaRndGoSpec("const_MatrixAvgDaRndGoSpec", 1, 0, 0, 0,1);
TypeDef TA_const_MatrixAvgDaRndGoSpec_ref("const_MatrixAvgDaRndGoSpec_ref", 1, 0, 1, 0,1);
...
TypeDef TA_SNrThalMiscSpec("SNrThalMiscSpec", " misc specs for the snrthal layer", 
	"INLINE ", "INLINE NO_UPDATE_AFTER ", "", sizeof(SNrThalMiscSpec), (void**)&TAI_SNrThalMiscSpec, 0, 0, 0,1);
TypeDef TA_const_SNrThalMiscSpec("const_SNrThalMiscSpec", 1, 0, 0, 0,1);
TypeDef TA_const_SNrThalMiscSpec_ref("const_SNrThalMiscSpec_ref", 1, 0, 1, 0,1);
...
TypeDef TA_PFCOutGateSpec("PFCOutGateSpec", " specifications for pfc output gating", 
	"INLINE ", "INLINE NO_UPDATE_AFTER ", "", sizeof(PFCOutGateSpec), (void**)&TAI_PFCOutGateSpec, 0, 0, 0,1);
TypeDef TA_const_PFCOutGateSpec("const_PFCOutGateSpec", 1, 0, 0, 0,1);
TypeDef TA_const_PFCOutGateSpec_ref("const_PFCOutGateSpec_ref", 1, 0, 1, 0,1);
TypeDef TA_PFCOutLayerSpec("PFCOutLayerSpec", " Prefrontal cortex output gated layer: gets gating signal from SNrThal and activations from PFC_mnt layer: gating modulates strength of activation", 
	"EXT_spec MEMB_IN_GPMENU ", "EXT_spec MEMB_IN_GPMENU ", "", sizeof(PFCOutLayerSpec), (void**)&TAI_PFCOutLayerSpec, 1, 0, 0,1);
TypeDef TA_const_PFCOutLayerSpec("const_PFCOutLayerSpec", 1, 0, 0, 0,1);
TypeDef TA_const_PFCOutLayerSpec_ref("const_PFCOutLayerSpec_ref", 1, 0, 1, 0,1);
...
LeabraUnitSpec*		 TAI_LeabraUnitSpec=NULL;
  ...
  static cssEl* cssElCFun_LeabraUnitSpec_Compute_NetRescale_stub(void* ths,int, cssEl** arg) {
    cssEl* rval=&cssMisc::Void;
    ((LeabraUnitSpec*)ths)->Compute_NetRescale((LeabraUnit*)(void*)*arg[1], (LeabraLayer*)(void*)*arg[2], (LeabraTrial*)(void*)*arg[3], (float)*arg[4]);
    return rval;}
  static cssEl* cssElCFun_LeabraUnitSpec_Init_ClampNet_stub(void* ths,int, cssEl** arg) {
    cssEl* rval=&cssMisc::Void;
    ((LeabraUnitSpec*)ths)->Init_ClampNet((LeabraUnit*)(void*)*arg[1], (LeabraLayer*)(void*)*arg[2], (LeabraTrial*)(void*)*arg[3]);
    return rval;}
...
LeabraUnit*		 TAI_LeabraUnit=NULL;
  ...
  static cssEl* cssElCFun_LeabraUnit_Compute_NetRescale_stub(void* ths,int, cssEl** arg) {
    cssEl* rval=&cssMisc::Void;
    ((LeabraUnit*)ths)->Compute_NetRescale((LeabraLayer*)(void*)*arg[1], (LeabraTrial*)(void*)*arg[2], (float)*arg[3]);
    return rval;}
  static cssEl* cssElCFun_LeabraUnit_Init_ClampNet_stub(void* ths,int, cssEl** arg) {
    cssEl* rval=&cssMisc::Void;
    ((LeabraUnit*)ths)->Init_ClampNet((LeabraLayer*)(void*)*arg[1], (LeabraTrial*)(void*)*arg[2]);
    return rval;}
...
LeabraLayerSpec*		 TAI_LeabraLayerSpec=NULL;
  ...
  static cssEl* cssElCFun_LeabraLayerSpec_Init_ClampNet_stub(void* ths,int, cssEl** arg) {
    cssEl* rval=&cssMisc::Void;
    ((LeabraLayerSpec*)ths)->Init_ClampNet((LeabraLayer*)(void*)*arg[1], (LeabraTrial*)(void*)*arg[2]);
    return rval;}
  ...
  static cssEl* cssElCFun_LeabraLayerSpec_Compute_LayInhibToGps_stub(void* ths,int, cssEl** arg) {
    cssEl* rval=&cssMisc::Void;
    ((LeabraLayerSpec*)ths)->Compute_LayInhibToGps((LeabraLayer*)(void*)*arg[1], (LeabraTrial*)(void*)*arg[2]);
    return rval;}
  ...
  static cssEl* cssElCFun_LeabraLayerSpec_Compute_NetRescale_stub(void* ths,int, cssEl** arg) {
    cssEl* rval=&cssMisc::Void;
    ((LeabraLayerSpec*)ths)->Compute_NetRescale((LeabraLayer*)(void*)*arg[1], (LeabraTrial*)(void*)*arg[2]);
    return rval;}
...
LeabraLayer*		 TAI_LeabraLayer=NULL;
  ...
  static cssEl* cssElCFun_LeabraLayer_Init_ClampNet_stub(void* ths,int, cssEl** arg) {
    cssEl* rval=&cssMisc::Void;
    ((LeabraLayer*)ths)->Init_ClampNet((LeabraTrial*)(void*)*arg[1]);
    return rval;}
  ...
  static cssEl* cssElCFun_LeabraLayer_Compute_LayInhibToGps_stub(void* ths,int, cssEl** arg) {
    cssEl* rval=&cssMisc::Void;
    ((LeabraLayer*)ths)->Compute_LayInhibToGps((LeabraTrial*)(void*)*arg[1]);
    return rval;}
...
LeabraMaxDa*		 TAI_LeabraMaxDa=NULL;
  ...
  static cssEl* cssElCFun_LeabraMaxDa_SendCon_Run_stub(void* ths,int, cssEl** arg) {
    ...
    return rval;}
  static cssEl* cssElCFun_LeabraMaxDa_Layer_Stat_stub(void* ths,int, cssEl** arg) {
    cssEl* rval=&cssMisc::Void;
    ((LeabraMaxDa*)ths)->Layer_Stat((Layer*)(void*)*arg[1]);
    return rval;}
...
MatrixLayerSpec*		 TAI_MatrixLayerSpec=NULL;
  ...
  static cssEl* cssElCFun_MatrixLayerSpec_Check_RndGoAvgRew_stub(void* ths,int, cssEl** arg) {
    cssEl* rval=&cssMisc::Void;
    rval=new cssInt((int)((MatrixLayerSpec*)ths)->Check_RndGoAvgRew((LeabraLayer*)(void*)*arg[1], (LeabraTrial*)(void*)*arg[2]));
    return rval;}
  static cssEl* cssElCFun_MatrixLayerSpec_Compute_UCondNoGoRndGo_stub(void* ths,int, cssEl** arg) {
    cssEl* rval=&cssMisc::Void;
    ((MatrixLayerSpec*)ths)->Compute_UCondNoGoRndGo((LeabraLayer*)(void*)*arg[1], (LeabraTrial*)(void*)*arg[2]);
    return rval;}
  static cssEl* cssElCFun_MatrixLayerSpec_Compute_ErrRndGo_stub(void* ths,int, cssEl** arg) {
    cssEl* rval=&cssMisc::Void;
    ((MatrixLayerSpec*)ths)->Compute_ErrRndGo((LeabraLayer*)(void*)*arg[1], (LeabraTrial*)(void*)*arg[2]);
    return rval;}
  static cssEl* cssElCFun_MatrixLayerSpec_Compute_AvgDaRndGo_stub(void* ths,int, cssEl** arg) {
    cssEl* rval=&cssMisc::Void;
    ((MatrixLayerSpec*)ths)->Compute_AvgDaRndGo((LeabraLayer*)(void*)*arg[1], (LeabraTrial*)(void*)*arg[2]);
    return rval;}
  ...
  static cssEl* cssElCFun_MatrixLayerSpec_Compute_MotorGate_stub(void* ths,int, cssEl** arg) {
    cssEl* rval=&cssMisc::Void;
    ((MatrixLayerSpec*)ths)->Compute_MotorGate((LeabraLayer*)(void*)*arg[1], (LeabraTrial*)(void*)*arg[2]);
    return rval;}
...
LeabraWiz*		 TAI_LeabraWiz=NULL;
  ...
  static cssEl* cssElCFun_LeabraWiz_BgPFC_stub(void* ths,int na, cssEl** arg) {
    ...
    if(na == 4) {
      ((LeabraWiz*)ths)->BgPFC((Network*)(void*)*arg[1], (bool)*arg[2], (bool)*arg[3], (bool)*arg[4]);}
    if(na == 5) {
      ((LeabraWiz*)ths)->BgPFC((Network*)(void*)*arg[1], (bool)*arg[2], (bool)*arg[3], (bool)*arg[4], (bool)*arg[5]);}
    if(na == 6) {
      ((LeabraWiz*)ths)->BgPFC((Network*)(void*)*arg[1], (bool)*arg[2], (bool)*arg[3], (bool)*arg[4], (bool)*arg[5], (bool)*arg[6]);}
    if(na == 7) {
      ((LeabraWiz*)ths)->BgPFC((Network*)(void*)*arg[1], (bool)*arg[2], (bool)*arg[3], (bool)*arg[4], (bool)*arg[5], (bool)*arg[6], (int)*arg[7]);}
    if(na == 8) {
      ((LeabraWiz*)ths)->BgPFC((Network*)(void*)*arg[1], (bool)*arg[2], (bool)*arg[3], (bool)*arg[4], (bool)*arg[5], (bool)*arg[6], (int)*arg[7], (bool)*arg[8]);}
    if(na == 9) {
      ((LeabraWiz*)ths)->BgPFC((Network*)(void*)*arg[1], (bool)*arg[2], (bool)*arg[3], (bool)*arg[4], (bool)*arg[5], (bool)*arg[6], (int)*arg[7], (bool)*arg[8], (bool)*arg[9]);}
    if(na == 10) {
      ((LeabraWiz*)ths)->BgPFC((Network*)(void*)*arg[1], (bool)*arg[2], (bool)*arg[3], (bool)*arg[4], (bool)*arg[5], (bool)*arg[6], (int)*arg[7], (bool)*arg[8], (bool)*arg[9], (bool)*arg[10]);}
    if(na == 11) {
      ((LeabraWiz*)ths)->BgPFC((Network*)(void*)*arg[1], (bool)*arg[2], (bool)*arg[3], (bool)*arg[4], (bool)*arg[5], (bool)*arg[6], (int)*arg[7], (bool)*arg[8], (bool)*arg[9], (bool)*arg[10], (bool)*arg[11]);}
    return rval;}
...
static MethodDef_data TA_LeabraUnitSpec_MethodDef[]={
  ...
  {&TA_void,NULL,"InitActAvg","","","",
    0,1,-1,0,NULL,cssElCFun_LeabraUnitSpec_InitActAvg_stub,TA_LeabraUnitSpec_InitActAvg_MethArgs},
  ...
  {&TA_void,NULL,"Compute_NetRescale"," rescale netinput scales by given amount","","",
    0,4,-1,0,NULL,cssElCFun_LeabraUnitSpec_Compute_NetRescale_stub,TA_LeabraUnitSpec_Compute_NetRescale_MethArgs},
  {&TA_void,NULL,"Init_ClampNet"," init clam net value prior to sending","","",
    0,3,-1,0,NULL,cssElCFun_LeabraUnitSpec_Init_ClampNet_stub,TA_LeabraUnitSpec_Init_ClampNet_MethArgs},
...
static MethodDef_data TA_LeabraUnit_MethodDef[]={
  ...
  {&TA_void,NULL,"InitActAvg","","","",
    0,0,-1,0,NULL,cssElCFun_LeabraUnit_InitActAvg_stub,NULL},
  {&TA_void,NULL,"SetCurLrate","","","",
  ...
  {&TA_void,NULL,"Compute_NetRescale","","","",
    0,3,-1,0,NULL,cssElCFun_LeabraUnit_Compute_NetRescale_stub,TA_LeabraUnit_Compute_NetRescale_MethArgs},
  {&TA_void,NULL,"Init_ClampNet","","","",
    0,2,-1,0,NULL,cssElCFun_LeabraUnit_Init_ClampNet_stub,TA_LeabraUnit_Init_ClampNet_MethArgs},
  {&TA_void,NULL,"Send_ClampNet","","","",
...
static MethodDef_data TA_LeabraLayerSpec_MethodDef[]={
  ...
  {&TA_void,NULL,"InitActAvg"," initialize act_avg values","","",
    0,1,-1,0,NULL,cssElCFun_LeabraLayerSpec_InitActAvg_stub,TA_LeabraLayerSpec_InitActAvg_MethArgs},
  {&TA_void,NULL,"SetCurLrate"," set current learning rate based on epoch","","",
  ...
  {&TA_void,NULL,"Init_ClampNet"," prior to settling: init clamp net variable prior to sending","","",
    0,2,-1,0,NULL,cssElCFun_LeabraLayerSpec_Init_ClampNet_stub,TA_LeabraLayerSpec_Init_ClampNet_MethArgs},
  ...
  {&TA_void,NULL,"Compute_Inhib_BreakTie"," break any ties in the kwta function","","",
    0,1,-1,0,NULL,cssElCFun_LeabraLayerSpec_Compute_Inhib_BreakTie_stub,TA_LeabraLayerSpec_Compute_Inhib_BreakTie_MethArgs},
  {&TA_void,NULL,"Compute_LayInhibToGps"," Stage 3.25: for layer groups, need to propagate inhib out to unit groups","","",
    0,2,-1,0,NULL,cssElCFun_LeabraLayerSpec_Compute_LayInhibToGps_stub,TA_LeabraLayerSpec_Compute_LayInhibToGps_MethArgs},
  ...
  {&TA_void,NULL,"Compute_NetRescale"," do net rescaling to prevent blowup based on netin.max","","",
    0,2,-1,0,NULL,cssElCFun_LeabraLayerSpec_Compute_NetRescale_stub,TA_LeabraLayerSpec_Compute_NetRescale_MethArgs},
...
static MethodDef_data TA_LeabraLayer_MethodDef[]={
  ...
  {&TA_void,NULL,"InitActAvg","","","",
    0,0,-1,0,NULL,cssElCFun_LeabraLayer_InitActAvg_stub,NULL},
  ...
  {&TA_void,NULL,"Init_ClampNet","","","",
    0,1,-1,0,NULL,cssElCFun_LeabraLayer_Init_ClampNet_stub,TA_LeabraLayer_Init_ClampNet_MethArgs},
  {&TA_void,NULL,"Send_ClampNet","","","",
  ...
  {&TA_void,NULL,"Compute_LayInhibToGps","","","",
    0,1,-1,0,NULL,cssElCFun_LeabraLayer_Compute_LayInhibToGps_stub,TA_LeabraLayer_Compute_LayInhibToGps_MethArgs},
  {&TA_void,NULL,"Compute_InhibAvg","","","",
...
static MethodArgs_data TA_LeabraMaxDa_SendCon_Run_MethArgs[]={
  {&TA_Unit_ptr,NULL,"na",""},
  NULL};
static MethodArgs_data TA_LeabraMaxDa_Layer_Stat_MethArgs[]={
  {&TA_Layer_ptr,NULL,"lay",""},
  NULL};
...
static MethodDef_data TA_LeabraMaxDa_MethodDef[]={
  ...
  {&TA_void,NULL,"Layer_Stat"," Compute statistic on a layer","","",
    1,1,-1,0,NULL,cssElCFun_LeabraMaxDa_Layer_Stat_stub,TA_LeabraMaxDa_Layer_Stat_MethArgs},
...
static MemberDef_data TA_KWTASpec_MemberDef[]={
  ...
  {&TA_float,NULL,"pat_q"," threshold for pat_k based activity level: add to k if ext > pat_q","DETAIL DEF_0.5 ","",
...
static MethodDef_data TA_MatrixLayerSpec_MethodDef[]={
  ...
  {&TA_bool,NULL,"Check_RndGoAvgRew"," check avg_rew levels to see whether we should compute random go (don't do when avg_rew is good!); false = don't do rnd go, true = do it","","",
    0,2,-1,0,NULL,cssElCFun_MatrixLayerSpec_Check_RndGoAvgRew_stub,TA_MatrixLayerSpec_Check_RndGoAvgRew_MethArgs},
  {&TA_void,NULL,"Compute_UCondNoGoRndGo"," compute random Go for unconditional and nogo cases","","",
    0,2,-1,0,NULL,cssElCFun_MatrixLayerSpec_Compute_UCondNoGoRndGo_stub,TA_MatrixLayerSpec_Compute_UCondNoGoRndGo_MethArgs},
  {&TA_void,NULL,"Compute_ErrRndGo"," compute random Go signal when errors have been made recently","","",
    0,2,-1,0,NULL,cssElCFun_MatrixLayerSpec_Compute_ErrRndGo_stub,TA_MatrixLayerSpec_Compute_ErrRndGo_MethArgs},
  {&TA_void,NULL,"Compute_AvgDaRndGo"," compute random Go signal based on average da values for stripes ","","",
    0,2,-1,0,NULL,cssElCFun_MatrixLayerSpec_Compute_AvgDaRndGo_stub,TA_MatrixLayerSpec_Compute_AvgDaRndGo_MethArgs},
  ...
  {&TA_void,NULL,"Compute_MotorGate"," compute gating signal for OUTPUT Matrix_out","","",
    0,2,-1,0,NULL,cssElCFun_MatrixLayerSpec_Compute_MotorGate_stub,TA_MatrixLayerSpec_Compute_MotorGate_MethArgs},
  NULL};
...
static MethodDef_data TA_PFCOutLayerSpec_MethodDef[]={
  {&TA_void,NULL,"HelpConfig"," get help message for configuring this spec","BUTTON ","",
    0,0,-1,0,NULL,cssElCFun_PFCOutLayerSpec_HelpConfig_stub,NULL},
  NULL};
