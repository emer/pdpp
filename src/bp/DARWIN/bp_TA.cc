...
TypeDef TA_BpConSpec("BpConSpec", " Bp connection specifications", 
	"EXT_spec MEMB_IN_GPMENU ", "EXT_spec MEMB_IN_GPMENU ", "", sizeof(BpConSpec), (void**)&TAI_BpConSpec, 1, 0, 0,1);
TypeDef TA_BpCon("BpCon", " Bp connection", 
	"NO_UPDATE_AFTER ", "NO_UPDATE_AFTER ", "", sizeof(BpCon), (void**)&TAI_BpCon, 0, 0, 0,1);
TypeDef TA_BpCon_Group("BpCon_Group", " group of Bp connections", 
	"NO_UPDATE_AFTER ", "NO_UPDATE_AFTER ", "", sizeof(BpCon_Group), (void**)&TAI_BpCon_Group, 0, 0, 0,1);
TypeDef TA_BpUnit("BpUnit", " standard feed-forward Bp unit ", 
	"NO_UPDATE_AFTER DMEM_SHARE_SETS_3 DMEM_SHARE_SETS_4 ", "NO_UPDATE_AFTER DMEM_SHARE_SETS_3 DMEM_SHARE_SETS_4 ", "", sizeof(BpUnit), (void**)&TAI_BpUnit, 0, 0, 0,1);
TypeDef TA_BpUnitSpec("BpUnitSpec", " specifications for Bp units", 
	"EXT_spec MEMB_IN_GPMENU ", "EXT_spec MEMB_IN_GPMENU ", "", sizeof(BpUnitSpec), (void**)&TAI_BpUnitSpec, 1, 0, 0,1);
TypeDef TA_BpTrial("BpTrial", " standard Bp feed-forward trial", 
	"EXT_proc MEMB_IN_GPMENU AGGOP_SUM ", "EXT_proc MEMB_IN_GPMENU AGGOP_SUM ", "", sizeof(BpTrial), (void**)&TAI_BpTrial, 1, 0, 0,1);
...
TypeDef TA_CE_Stat("CE_Stat", " Cross-entropy error statistic (asymmetric divergence)", 
	"EXT_proc COMPUTE_IN_TrialProcess ", "EXT_proc COMPUTE_IN_TrialProcess ", "", sizeof(CE_Stat), (void**)&TAI_CE_Stat, 1, 0, 0,1);
...
TypeDef TA_NormDotProd_Stat("NormDotProd_Stat", " Normalized Dot Product of act and target values", 
	"EXT_proc COMPUTE_IN_TrialProcess ", "EXT_proc COMPUTE_IN_TrialProcess ", "", sizeof(NormDotProd_Stat), (void**)&TAI_NormDotProd_Stat, 1, 0, 0,1);
...
TypeDef TA_VecCor_Stat("VecCor_Stat", " Vector Correlation of act and target values", 
	"EXT_proc COMPUTE_IN_TrialProcess ", "EXT_proc COMPUTE_IN_TrialProcess ", "", sizeof(VecCor_Stat), (void**)&TAI_VecCor_Stat, 1, 0, 0,1);
...
TypeDef TA_NormVecLen_Stat("NormVecLen_Stat", " Normalized Vector Length of act and target values", 
	"EXT_proc COMPUTE_IN_TrialProcess ", "EXT_proc COMPUTE_IN_TrialProcess ", "", sizeof(NormVecLen_Stat), (void**)&TAI_NormVecLen_Stat, 1, 0, 0,1);
...
TypeDef TA_HebbBpConSpec("HebbBpConSpec", " Simple Hebbian wt update (send act * recv act)", 
	"EXT_spec MEMB_IN_GPMENU ", "EXT_spec MEMB_IN_GPMENU ", "", sizeof(HebbBpConSpec), (void**)&TAI_HebbBpConSpec, 1, 0, 0,1);
...
TypeDef TA_ErrScaleBpConSpec("ErrScaleBpConSpec", " con spec that scales the error by given parameter", 
	"EXT_spec MEMB_IN_GPMENU ", "EXT_spec MEMB_IN_GPMENU ", "", sizeof(ErrScaleBpConSpec), (void**)&TAI_ErrScaleBpConSpec, 1, 0, 0,1);
...
TypeDef TA_DeltaBarDeltaBpCon("DeltaBarDeltaBpCon", " delta-bar-delta connection object with local learning rate", 
	"NO_UPDATE_AFTER ", "NO_UPDATE_AFTER ", "", sizeof(DeltaBarDeltaBpCon), (void**)&TAI_DeltaBarDeltaBpCon, 0, 0, 0,1);
...
TypeDef TA_DeltaBarDeltaBpConSpec("DeltaBarDeltaBpConSpec", " delta-bar-delta has local learning rates for each connection", 
	"EXT_spec MEMB_IN_GPMENU ", "EXT_spec MEMB_IN_GPMENU ", "", sizeof(DeltaBarDeltaBpConSpec), (void**)&TAI_DeltaBarDeltaBpConSpec, 1, 0, 0,1);
...
TypeDef TA_BpContextSpec("BpContextSpec", " for context units in simple recurrent nets (SRN), expects one-to-one prjn from layer it copies, must be AFTER that layer in .layers", 
	"EXT_spec MEMB_IN_GPMENU ", "EXT_spec MEMB_IN_GPMENU ", "", sizeof(BpContextSpec), (void**)&TAI_BpContextSpec, 1, 0, 0,1);
...
TypeDef TA_LinearBpUnitSpec("LinearBpUnitSpec", " linear unit in Bp", 
	"EXT_spec MEMB_IN_GPMENU ", "EXT_spec MEMB_IN_GPMENU ", "", sizeof(LinearBpUnitSpec), (void**)&TAI_LinearBpUnitSpec, 1, 0, 0,1);
...
TypeDef TA_ThreshLinBpUnitSpec("ThreshLinBpUnitSpec", " thresholded linear unit in Bp", 
	"EXT_spec MEMB_IN_GPMENU ", "EXT_spec MEMB_IN_GPMENU ", "", sizeof(ThreshLinBpUnitSpec), (void**)&TAI_ThreshLinBpUnitSpec, 1, 0, 0,1);
...
TypeDef TA_NoisyBpUnitSpec("NoisyBpUnitSpec", " Bp with noisy output signal (act plus noise)", 
	"EXT_spec MEMB_IN_GPMENU ", "EXT_spec MEMB_IN_GPMENU ", "", sizeof(NoisyBpUnitSpec), (void**)&TAI_NoisyBpUnitSpec, 1, 0, 0,1);
...
TypeDef TA_StochasticBpUnitSpec("StochasticBpUnitSpec", " Bp with a binary stochastic activation function", 
	"EXT_spec MEMB_IN_GPMENU ", "EXT_spec MEMB_IN_GPMENU ", "", sizeof(StochasticBpUnitSpec), (void**)&TAI_StochasticBpUnitSpec, 1, 0, 0,1);
...
TypeDef TA_RBFBpUnitSpec("RBFBpUnitSpec", " Radial basis function (Gaussian) function units in Bp", 
	"EXT_spec MEMB_IN_GPMENU ", "EXT_spec MEMB_IN_GPMENU ", "", sizeof(RBFBpUnitSpec), (void**)&TAI_RBFBpUnitSpec, 1, 0, 0,1);
...
TypeDef TA_BumpBpUnitSpec("BumpBpUnitSpec", " bump function in Bp: Gaussian of std net input", 
	"EXT_spec MEMB_IN_GPMENU ", "EXT_spec MEMB_IN_GPMENU ", "", sizeof(BumpBpUnitSpec), (void**)&TAI_BumpBpUnitSpec, 1, 0, 0,1);
...
TypeDef TA_ExpBpUnitSpec("ExpBpUnitSpec", " exponential units in Bp: simple exponent of net input", 
	"EXT_spec MEMB_IN_GPMENU ", "EXT_spec MEMB_IN_GPMENU ", "", sizeof(ExpBpUnitSpec), (void**)&TAI_ExpBpUnitSpec, 1, 0, 0,1);
...
TypeDef TA_SoftMaxBpUnitSpec("SoftMaxBpUnitSpec", " SoftMax Units: first one-to-one prjn is from corresp exponential unit, second prjn is from single summing linear unit, this then divides two ", 
	"EXT_spec MEMB_IN_GPMENU ", "EXT_spec MEMB_IN_GPMENU ", "", sizeof(SoftMaxBpUnitSpec), (void**)&TAI_SoftMaxBpUnitSpec, 1, 0, 0,1);
TypeDef TA_RBpConSpec("RBpConSpec", " Recurrent Backprop Con Spec", 
	"EXT_spec MEMB_IN_GPMENU ", "EXT_spec MEMB_IN_GPMENU ", "", sizeof(RBpConSpec), (void**)&TAI_RBpConSpec, 1, 0, 0,1);
TypeDef TA_const_SoftMaxBpUnitSpec("const_SoftMaxBpUnitSpec", 1, 0, 0, 0,1);
TypeDef TA_RBpUnit("RBpUnit", " recurrent BP unit", 
	"NO_UPDATE_AFTER DMEM_SHARE_SETS_3 DMEM_SHARE_SETS_4 ", "NO_UPDATE_AFTER DMEM_SHARE_SETS_3 DMEM_SHARE_SETS_4 ", "", sizeof(RBpUnit), (void**)&TAI_RBpUnit, 0, 0, 0,1);
...
TypeDef TA_RBpUnitSpec("RBpUnitSpec", " Recurrent Backprop Unit Specification", 
	"EXT_spec MEMB_IN_GPMENU ", "EXT_spec MEMB_IN_GPMENU ", "", sizeof(RBpUnitSpec), (void**)&TAI_RBpUnitSpec, 1, 0, 0,1);
TypeDef TA_RBpTrial("RBpTrial", " one presentation of an event to RBp", 
	"EXT_proc MEMB_IN_GPMENU AGGOP_SUM ", "EXT_proc MEMB_IN_GPMENU AGGOP_SUM ", "", sizeof(RBpTrial), (void**)&TAI_RBpTrial, 1, 0, 0,1);
TypeDef TA_RBpSequence("RBpSequence", " one sequence of events, handles TimeEvents properly", 
	"EXT_proc MEMB_IN_GPMENU AGGOP_SUM ", "EXT_proc MEMB_IN_GPMENU AGGOP_SUM ", "", sizeof(RBpSequence), (void**)&TAI_RBpSequence, 1, 0, 0,1);
TypeDef TA_APBpCycle("APBpCycle", " one cycle of processing in almeida-pineda (either act or bp depending on 'phase')", 
	"EXT_proc MEMB_IN_GPMENU AGGOP_SUM ", "EXT_proc MEMB_IN_GPMENU AGGOP_SUM ", "", sizeof(APBpCycle), (void**)&TAI_APBpCycle, 1, 0, 0,1);
TypeDef TA_APBpSettle("APBpSettle", " one settling phase in Almeide-Pineda (either act or bp depending on phase)", 
	"EXT_proc MEMB_IN_GPMENU AGGOP_SUM ", "EXT_proc MEMB_IN_GPMENU AGGOP_SUM ", "", sizeof(APBpSettle), (void**)&TAI_APBpSettle, 1, 0, 0,1);
TypeDef TA_APBpTrial("APBpTrial", " one Almeida-Pineda BP Trial", 
	"EXT_proc MEMB_IN_GPMENU AGGOP_SUM ", "EXT_proc MEMB_IN_GPMENU AGGOP_SUM ", "", sizeof(APBpTrial), (void**)&TAI_APBpTrial, 1, 0, 0,1);
TypeDef TA_APBpMaxDa_De("APBpMaxDa_De", " _ computes max of da and ddE to determine when to stop settling in almeida-pineda algorithm ", 
	"EXT_proc COMPUTE_IN_SettleProcess LOOP_STAT ", "EXT_proc COMPUTE_IN_SettleProcess LOOP_STAT ", "", sizeof(APBpMaxDa_De), (void**)&TAI_APBpMaxDa_De, 1, 0, 0,1);
...
TypeDef TA_SymRBpConSpec("SymRBpConSpec", " Recurrent Backprop Con Spec: option to maintain weight symmetry through simple averaging of two weight changes", 
	"EXT_spec MEMB_IN_GPMENU ", "EXT_spec MEMB_IN_GPMENU ", "", sizeof(SymRBpConSpec), (void**)&TAI_SymRBpConSpec, 1, 0, 0,1);
...
TypeDef TA_RBpSE_Stat("RBpSE_Stat", " Squared error for recurrent backprop, mulitplies by dt", 
	"EXT_proc COMPUTE_IN_TrialProcess ", "EXT_proc COMPUTE_IN_TrialProcess ", "", sizeof(RBpSE_Stat), (void**)&TAI_RBpSE_Stat, 1, 0, 0,1);
...
TypeDef TA_RBpContextSpec("RBpContextSpec", " RBp version of context units in simple recurrent nets (SRN), expects one-to-one prjn from layer it copies, Trial->CopyContext() must be called by script to update!", 
	"EXT_spec MEMB_IN_GPMENU ", "EXT_spec MEMB_IN_GPMENU ", "", sizeof(RBpContextSpec), (void**)&TAI_RBpContextSpec, 1, 0, 0,1);
...
TypeDef TA_NoisyRBpUnitSpec("NoisyRBpUnitSpec", " RBp with noisy output signal (act plus noise)", 
	"EXT_spec MEMB_IN_GPMENU ", "EXT_spec MEMB_IN_GPMENU ", "", sizeof(NoisyRBpUnitSpec), (void**)&TAI_NoisyRBpUnitSpec, 1, 0, 0,1);
...
TypeDef TA_BpWizard("BpWizard", " backprop-specific wizard for automating construction of simulation objects", 
	"BUTROWS_2 EDIT_WIDTH_60 ", "BUTROWS_2 EDIT_WIDTH_60 ", "", sizeof(BpWizard), (void**)&TAI_BpWizard, 1, 0, 0,1);
