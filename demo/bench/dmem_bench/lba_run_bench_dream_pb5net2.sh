...
$mpirn -np 10 $dmlba -nogui -f startup_pb5net2.css lba_dmem_50.proj.gz 100 >>& lba_bench.out
...
$mpirn -np 10 $dmlba -nogui -f startup_pb5net2.css lba_dmem_100.proj.gz 25 >>& lba_bench.out
...
$mpirn -np 10 $dmlba -nogui -f startup_pb5net2.css lba_dmem_200.proj.gz 6 >>& lba_bench.out
...
$mpirn -np 10 $dmlba -nogui -f startup_pb5net2.css lba_dmem_500.proj.gz 1 >>& lba_bench.out
